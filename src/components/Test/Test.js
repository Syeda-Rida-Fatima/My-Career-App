...
// import { ToastContainer, toast } from 'react-toastify'; // Replace with equivalent Toast component in React Native
// import axios from 'axios';
// import { tokenValue } from '../User/Login';
// import { dummy_answers } from '../../data/dummy-response'; // Make sure you have the required data
// import { questions } from './questions';
let data = null;

// export const setTestData = (responseData) => {
//   data = responseData;
// };
        ...
        <View style={styles.container}>
            ...
            <ScrollView style={styles.scrollView}>
                <View style={styles.noteContainer}>
                    ...
                    <Text style={styles.noteText}>
                        It is advised not to spend much time on choosing the right option.
                    </Text>
                    <Text style={styles.noteText}>
                        All information will be used solely for educational and research purposes.
                    </Text>
                    <Text style={styles.noteText}>
                        We will NOT, in any circumstances, share your information with other individuals or organizations.
                    </Text>
                </View>
                <View style={styles.buttonContainer}>
                    <TouchableOpacity
                        onPress={() => handleButtonSelection(0.0)}
                        style={[
                            styles.button,
                            selectedButton === 0.0 ? styles.selectedButton : null,
                        ]}
                    >
                        <Text style={styles.buttonText}>Medical</Text>
                    </TouchableOpacity>
                    <TouchableOpacity
                        onPress={() => handleButtonSelection(1.0)}
                        style={[
                            styles.button,
                            selectedButton === 1.0 ? styles.selectedButton : null,
                        ]}
                    >
                        <Text style={styles.buttonText}>Engineering</Text>
                    </TouchableOpacity>
                    <TouchableOpacity
                        onPress={() => handleButtonSelection(2.0)}
                        style={[
                            styles.button,
                            selectedButton === 2.0 ? styles.selectedButton : null,
                        ]}
                    >
                            ...
                            <View style={styles.optionsContainer}>
                                {question.answerOptions.map((option, optionIndex) => (
                                    <TouchableOpacity
                                        ...
                                        style={[
                                            styles.optionButton,
                                            Myanswers[question.id] === optionIndex ? styles.selectedOption : null,
                                        ]}
                                        onPress={() => handleOptionClick(question.id, optionIndex)}
                                    >
                ...
                //  !isAllQuestionsAnswered ? styles.disabledButton : null]}
